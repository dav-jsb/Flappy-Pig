...
class FlappyPig:
    ...
    def create_item(self, center_item): #Modificar posteriormente para em vez de receber uma cor, receber uma imagem para trocar ao coletar
        ...
        if item_type == "blue" :
            item_image = "novo flappypig/assets/coletaveis/wizard powerup.png"
        elif item_type == 'red' :
            item_image = "novo flappypig/assets/coletaveis/fire powerup.png"
        elif item_type == 'white' :
            item_image = "novo flappypig/assets/coletaveis/spider powerup.png"
        new_item = Item(self.width + 60, y, item_type, item_image)
    ...
    def run_game(self): ###loop principal do jogo
        ...
        while running:
            ...
            if self.manager.state == GameState.MENU: ##o que fazer na tela de menu
                ...
                # Renderização
                terreno = pygame.image.load("novo flappypig/assets/cenario/terreno.png")
                nuvens = pygame.image.load("novo flappypig/assets/cenario/nuvens/Background_112.png")
